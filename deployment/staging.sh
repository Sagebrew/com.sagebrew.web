...
DOCKERRUN_WEB_ENVIRONMENT=~/com.sagebrew.web/sagebrew/$SHA1-staging_Docker_web_environment.txt
DOCKERRUN_WORKER_ENVIRONMENT=~/com.sagebrew.web/sagebrew/$SHA1-staging_Docker_worker_environment.txt
