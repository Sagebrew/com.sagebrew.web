...
DOCKERRUN_WEB_ENVIRONMENT=/home/ubuntu$PROJECT_REPONAME/$SHA1-staging_Docker_web_environment.txt
DOCKERRUN_WORKER_ENVIRONMENT=/home/ubuntu$PROJECT_REPONAME/$SHA1-staging_Docker_worker_environment.txt
