...
Solutions, providing [Context][4], citing sources and organizing the information 
you wish to present.
...
To nest the list, use 4 spaces before the `-` symbol. 
For example:
...
especially when citing one of your [research studies][3] or journal articles. 
...
For example:
    ...
    [2]: https://s3.amazonaws.com/sagebrew/theo.jpg
...
### Videos ###
*Please note that we currently don't allow videos in the Conversation Cloud and
any raw HTML shall be stripped out of the input for security reasons. Videos can only
be inserted into Quests that you have edit rights to.*
...
``` ` ```s. This will result in an inline preformatting which doesn't handle spacing
but does allow for you to specify pieces of text you don't want the markdown
...
and your preformatted text if you are using the 4 spaces rather than ``` ` ```s.
...
[1]: https://www.google.com 
[2]: https://s3.amazonaws.com/sagebrew/theo.jpg
[3]: /help/conversation/research/
[4]: /help/questions/context/
