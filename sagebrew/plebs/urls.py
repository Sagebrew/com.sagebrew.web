...
from .views import (get_user_search_view, ProfileView,
                    ...
                    quest_settings, delete_quest, authenticate_representative)
...
urlpatterns = patterns(
    ...
    url(r'^(?P<pleb_username>[A-Za-z0-9.@_%+-]{1,30})/friends/$',
        ...
        name="friend_page"),
    url(r'^(?P<pleb_username>[A-Za-z0-9.@_%+-]{1,30})/quest_charts/$',
        ProfileView.as_view(template_name='sb_quest_chart.html'),
        name='quest_charts'),
