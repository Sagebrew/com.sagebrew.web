...
COMPANY_ACRONYMS = [('ABC', 'Abc'), ('CNN', 'Cnn'), ('CBS', 'Cbs'),
                    ('MSNBC', 'Msnbc'), ('BBC', 'Bbc'),
                    ('CBC', 'Cbc'), ('CBS', 'Cbs'), ('NBC', 'Nbc'),
                    ('NYT', 'Nyt'), ('PBS', 'Pbs'), ('abc7.com', 'Abc7.com'),
                    ('NPR', 'Npr'), ('N.P.R.', 'N.p.r'), ('N.P.R', 'N.p.r'),
                    ('N.Y.T', 'N.y.t'), ('N.Y.T.', 'N.y.t.'), ('TYT', 'Tyt'),
                    ('T.Y.T.', 'T.y.t.'), ('FBI', 'Fbi'), ('F.B.I', 'F.b.i'),
                    ('F.B.I.', 'F.b.i.'), ('CIA', 'Cia'), ('C.I.A.', 'C.i.a.'),
                    ('C.I.A', 'C.i.a'), ('NSA', 'Nsa'), ('N.S.A', 'N.s.a'),
                    ('N.S.A.', 'N.s.a.'), ('NASA', 'Nasa'),
                    ('N.A.S.A', 'N.a.s.a'), ('N.A.S.A.', 'N.a.s.a.'),
                    ('FEMA', 'Fema'), ('F.E.M.A.', 'F.e.m.a.'),
                    ('F.E.M.A', 'F.e.m.a'), ('DOJ', 'Doj'), ('D.O.J', 'D.o.j'),
                    ('D.O.J.', 'D.o.j.'), ('CDC', 'Cdc'), ('C.D.C', 'C.d.c'),
                    ('C.D.C.', 'C.d.c.'), ('HEPA', 'Hepa'),
                    ('H.E.P.A', 'H.e.p.a'), ('H.E.P.A.', 'H.e.p.a.'),
                    ('U.S.', 'U.s.'), ('US', 'Us'), ('USA', 'Usa'),
                    ('U.S.A.', 'U.s.a.'), ('U.S.A', 'U.s.a'),
                    ('APC', 'Apc'), ('PDP', 'Pdp'), ('ISIS', 'Isis'),
                    ('World War II', 'World War Ii'),
                    ('World War I', 'World War i'), ('DC', 'Dc'),
                    ('D.C.', 'D.c.'), ('DMV', 'Dmv'), ('DNC', 'Dnc'),
