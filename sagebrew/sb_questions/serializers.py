...
class QuestionSerializerDynamo(serializers.Serializer):
    ...
    # from there
    question_owner_name = serializers.CharField()
    question_owner_url = serializers.CharField()
    ...
    question_owner_email = serializers.CharField()
