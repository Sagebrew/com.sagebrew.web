$(document).ready(function () {
    ...
    function createQuestion() {
        var submitArea = $(".submit_question-action"),
            ...
            regexMatches = $('textarea#wmd-input-0').val().match(regExp);
        submitArea.attr("disabled", "disabled");
        if (tags === "") {
            tags = [];
        }
        if (!regexMatches) {
            $.notify({type: "danger", message: "Please include at least 1 url linking to information to add context or support to your question!"});
