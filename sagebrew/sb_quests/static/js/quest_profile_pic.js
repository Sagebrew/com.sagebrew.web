...
$(document).ready(function () {
    ...
    var croppicContainerEyecandyOptions = {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (profileImg.length === 0) {
                        $(".croppedImg").remove();
                        $("#cropQuestProfilePictureEyecandy").append('<img id="profile_pic" src="' + data.profile_pic + "?" + new Date().getTime() + '" style="width:96px;">');
                    } else {
        ...
        loaderHtml: '<div class="loader croppic-loader-quest-profile"><span id="bubblingG_1"></span><span id="bubblingG_2"></span><span id="bubblingG_3"></span></div> '
    };
