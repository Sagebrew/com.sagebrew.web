...
class ProfileUtils(object):
    ...
    def get_current_user_info(self):
        return_dict = {
            ...
            'friend_requests':
                self.current_user_friends.pending_received_list.all(),
            'sent_friend_requests':
                self.current_user_friends.pending_sent_list.all(),
        ...
        return_dict = {
            ...
            "friends": {
                ...
                "pending_received_list":
                    self.current_user.profile.friends.pending_received_list
                        .all(),
                "user_list":
